...
import { cn } from '@/lib/utils'; // Import cn for className handling
    ...
    <StyledWrapper className={cn(className)}>
      <ul className="example-2">
        <li className="icon-content">
          <a data-social="whatsapp" aria-label="Whatsapp" href={whatsappLink} target="_blank" rel="noopener noreferrer">
        ...
        <li className="icon-content">
          <a data-social="facebook" aria-label="Facebook" href={facebookLink} target="_blank" rel="noopener noreferrer">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a data-social="instagram" aria-label="Instagram" href={instagramLink} target="_blank" rel="noopener noreferrer">
            <div className="filled" />
...
const StyledWrapper = styled.div`
  ...
  .example-2 {
    display: flex;
    /* justify-content: center; // Esto se manejará con className si es necesario */
    align-items: center;
  }

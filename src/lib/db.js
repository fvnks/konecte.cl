...
function query(sql, params) {
    return __awaiter(this, void 0, void 0, function () {
        var queryId, currentPool, connection, rows, error_2, errorMessage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    ...
                    console.log("[DB_QUERY_EXEC_SUCCESS-".concat(queryId, "] SQL executed (Conn ID: ").concat(connection.threadId, "). Rows: ").concat(Array.isArray(rows) ? rows.length : 'N/A'));
                ...
                case 5:
                    ...
                    _a.label = 6;
                case 6: throw error_2; // Re-throw the original error to preserve the stack trace and detailed info
                case 7:
                    if (connection) {

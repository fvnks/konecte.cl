        ...
        <CardHeader className="pb-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    ...
                    <CardDescription>Supervisa, filtra y visualiza todas las visitas en la plataforma.</CardDescription>
                </div>
                 <Button asChild variant="outline" size="sm">
                    <Link href="/admin/visits/schedule">Agendar Nueva Visita</Link>
                </Button>
            </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <Tabs defaultValue="list_view">
            <div className="flex justify-between items-end">
              <TabsList>
                <TabsTrigger value="list_view">Vista de Tabla</TabsTrigger>
                <TabsTrigger value="calendar_view">Vista de Calendario</TabsTrigger>
              </TabsList>
               <Button onClick={handleFilterChange} variant="ghost" size="sm" disabled={isRefreshing || isLoading} aria-label="Refrescar visitas" className="hidden md:flex">
                  <RefreshCw className={`h-4 w-4 ${isRefreshing || isLoading ? 'animate-spin' : ''} mr-2`} /> Refrescar
              </Button>
            </div>
            ...
            <TabsContent value="list_view">
              ...
              {statusCounts ? (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-3 my-4">
            ...
            <TabsContent value="calendar_view">
              {isLoading ? (

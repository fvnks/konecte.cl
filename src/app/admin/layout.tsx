...
import { Home, Settings, Users, LayoutDashboard, ShieldAlert, CreditCard, ListOrdered, Brush, FileSearch } from 'lucide-react';
...
const adminNavItems = [
  ...
  { href: '/admin/requests', label: 'Gestión de Solicitudes', icon: <FileSearch className="h-5 w-5" /> },
];

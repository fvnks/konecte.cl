...
const SQL_STATEMENTS: string[] = [
  ...
  // users (role_id description updated, plan_id description updated)
  ...
  // properties (No schema changes, indices and table def remain)
  ...
  // property_requests (No schema changes, indices and table def remain)
  ...
  // comments (No schema changes, indices and table def remain)
  ...
  // user_comment_interactions (No schema changes, indices and table def remain)
  ...
  // google_sheet_configs (No schema changes, just purpose description change)
  ...
  // site_settings (Ensure landing_sections_order reflects 'analisis_whatsbot')
  ...
  // contacts (CRM) (No schema changes)
  ...
  // contact_interactions (CRM) (No schema changes)
  ...
  // chat_conversations (No schema changes)
  ...
  // chat_messages (No schema changes)
  ...
  // editable_texts (No schema changes)
  ...
  // property_views (No schema changes)
  ...
  // property_inquiries (No schema changes)
  ...
  // --- Property Visits Table --- (No schema changes)
  ...
  // --- Broker Collaboration Table --- (No schema changes)
  ...
  // --- Contact Form Submissions Table --- (No schema changes)
  ...
  // --- User Listing Interactions Table --- (No schema changes)
  ...
  // --- User AI Search Usage Table (REMOVED) ---

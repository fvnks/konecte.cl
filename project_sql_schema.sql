...
-- Usamos la función UUID() de MySQL para generar los IDs.
...
(UUID(), 'Gratis Corredor', 'Publicación gratuita de propiedades y solicitudes. Sin acceso a datos de contacto de personas naturales.', 0.00, 5, 5, 30, FALSE, FALSE, 5, FALSE, 0, FALSE, 10, 2, TRUE, TRUE, FALSE),
...
-- Índices para `property_requests`
...
-- Índices para `user_comment_interactions`
...
-- Insertar configuración inicial para `google_sheet_configs`
...
-- Tabla: `user_listing_interactions` (Interacciones con Listados)
...
-- Índices para `user_listing_interactions`
...
-- Tabla: `user_usage_metrics` (Métricas de Uso del Usuario)
...
-- Tabla: `user_action_logs` (Registros de Acciones de Usuario)
